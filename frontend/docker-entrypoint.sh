...
window.__APP_CONFIG__ = {
  ...
  REACT_APP_DOCTOR_API_URL: "${REACT_APP_DOCTOR_API_URL:-http://smart-healthcare.local/api}",
  REACT_APP_APPOINTMENT_API_URL: "${REACT_APP_APPOINTMENT_API_URL:-http://smart-healthcare.local/api}",
